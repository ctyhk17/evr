        ...
        <div  style="margin: 0 auto;max-width:100%;min-width: 980px;clear: none;float: none;">
			...
			<div class="pageBox">
				<div class="section1">
					...
					<div class="tabler">
			    		...
			    		<tr>
			    			...
			    			<td id="tdAdsubTrgtArea">
			    				<table>
			    					<c:forEach var="resultAdsubTrgtCdMap" items="${resultAdsubTrgtCdList}" varStatus="status">
					    						...
					    						<td style="border: 0px; margin-left: 0; margin-top: 0; margin-bottom: 0; padding: 0 0 0 0; line-height: 30px;">
								    				<select name="adsubTrgtCd" id="adsubTrgtCd" style="width:200px;"  onchange="fncDupChkeck(this);">
														<option value="">선택하세요</option>											
															<c:forEach var="adsubTrgtCdMap" items="${adsubTrgtCdList}">
																<option value="${ adsubTrgtCdMap.cd }" <c:if test="${ resultAdsubTrgtCdMap.adsubTrgtCd eq adsubTrgtCdMap.cd }" >selected="selected"</c:if> >${ adsubTrgtCdMap.cdNm }</option>
															</c:forEach>
											         </select>	
			    						...
			    						<c:if test="${ not status.first }" >
			    							<tr>
												<td style="border: 0px; margin-left: 0; margin-top: 0; margin-bottom: 0; padding: 0 0 0 0;  line-height: 33px;">
													<select name="adsubTrgtCd" id="adsubTrgtCd" style="width:200px;"  onchange="fncDupChkeck(this);">
														<option value="">선택하세요</option>											
															<c:forEach var="adsubTrgtCdMap" items="${adsubTrgtCdList}" >
																<option value="${ adsubTrgtCdMap.cd }" <c:if test="${ resultAdsubTrgtCdMap.adsubTrgtCd eq adsubTrgtCdMap.cd }" >selected="selected"</c:if> >${ adsubTrgtCdMap.cdNm }</option>
													...
													&nbsp;<input type="button" value="-" class="btn_gray" onClick="fncDeleteRow(this)">
												</td>
											</tr>
			    						</c:if>
			      ...
			      <%-- 하단 버튼 시작 --%>
					<div class="tr">
						<input type="button" value="저장" class="btn_blue" id="btnUpdate">
						<input type="button" value="취소" class="btn_blue" id="btnGoView">
					</div>
					<%-- 하단 버튼 시작 --%>
